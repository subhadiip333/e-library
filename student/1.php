...
<body>
    <header>
        ...
        <div class="card">
            ...
            <div class="image">
                <img src="37.jpg" width="300" height="400"></a>
                <a href="পোস্ট_্মাস্টার.pdf"><button class="btn">
                    <h2>Read Now</h2>
                </button></a>
                <div class="des">
                    <h1>পোস্ট_্মাস্টার<br> Author - রবীন্দ্রনাথ ঠাকুর<br>
