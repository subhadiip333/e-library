...
<head>
    ...
    <title>Bond Collection For Children</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <header>
        ...
        <div class="card">
            ...
            <div class="image">
                <img src="39.png" width="300" height="400"></a>
                <a href="Ruskin Bond ( PDFDrive ).pdf"><button class="btn">
                    <h2>Read Now</h2>
                </button></a>
                <div class="des">
                    <h1>Bond Collection For Children<br> Author - RUSKIN BOND<br>
